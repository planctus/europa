...
Feature: Publication List shows on page bottom with filters that have or not default values.
  ...
  Background:
    ...
    Given "Publication" content:
      | title    | field_core_date_updated:value | field_core_date_updated:value2 | field_core_date_published:value | field_core_date_published:value | field_core_description | field_publication_collection | field_publication_type | status |
      | Pub 2014 | 1400980800                    | 1400980800                     | 1400980800                      | 1400980800                      | Content description    | 0                            | Pub type               | 1      |
      | Pub 2016 | 1483099200                    | 1483099200                     | 1483099200                      | 1483099200                      | Content description    | 0                            | Pub type 2             | 1      |
  ...
  Scenario: One page with Publication List and all filters exposed
    ...
    Then I should see "- All years -" in the "#edit-field-core-date-published-value-year" element
  ...
  Scenario: Page with Publication List where publications have their metadata above the title
    Given I am viewing a "Page" content:
      | title                         | Page w/ Pub List |
      | field_publications_visibility | 1                |
      | language                      | en               |
      | status                        | 1                |
    Then I should see "Pub type 2"
    Then I should see "30 December 2016"
    Then I should see "Pub type"
    Then I should see "25 May 2014"
