    ...
    <tr id="forum-list-<?php print $child_id; ?>" class="<?php print $forum->zebra; ?>">
      <td <?php print $forum->is_container ? 'colspan="4" class="container"' : 'class="forum"'; ?>>
        ...
        <?php print str_repeat('<div class="indent">', $forum->depth); ?>
          ...
          <div class="name"><a href="<?php print filter_xss($forum->link); ?>"><?php print filter_xss($forum->name); ?></a></div>
      ...
      <?php if (!$forum->is_container): ?>
        <td class="topics">
          ...
          <?php if ($forum->new_topics): ?>
            <br />
            <a href="<?php print filter_xss($forum->new_url); ?>"><?php print filter_xss($forum->new_text); ?></a>
          <?php endif; ?>
        </td>
