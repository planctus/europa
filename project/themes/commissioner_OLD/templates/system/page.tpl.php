 ...
 */
?>
<div class="region-branding-wrapper">
  <div class="container">
...
<div class="page-wrapper">
    ...
    <div class="navbar-wrapper">
      <div class="container">
        <div class="navbar-header">
          <?php if ($logo): ?>
          <a class="logo navbar-btn pull-left" href="http://ec.europa.eu/index_en.htm" title="<?php print $home_page_link_title; ?>" rel="home" tabindex="2">
            <img alt="<?php print $logo_alt; ?>" src="<?php print $logo; ?>" />
          </a>
          <?php endif; ?>

          <?php if (!empty($site_name)): ?>
          <span class="name navbar-brand"><?php print $site_name; ?></span>
          <?php endif; ?>
  ...
  <main class="main-container container">
    ...
    <div class="row">
      ...
      <section class="section-main-content <?php print $content_column_class; ?> col-sm-12">
