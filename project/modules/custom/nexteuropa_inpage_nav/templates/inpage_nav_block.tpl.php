...
<div class="inpage-nav">
    <nav class="navbar navbar-default navbar-fixed-top inpage-nav__navbar">
        <div class="container">
            <div class="navbar-header"  data-toggle="collapse" data-target="#inpage-navigation-list" aria-expanded="false" aria-controls="navbar">
                <button type="button" class="navbar-toggle collapsed">
                    <span class="sr-only"><?php print t("Toggle navigation"); ?></span>
                    <span class="arrow-down"></span>
                    <span class="close-text"><?php print t("Close");?></span>
                </button>
                <span class="inpage-nav__help"><?php print t('On this page'); ?></span>
